...
![](http://chen_tiefeng.gitee.io/cloudimg/img/o2GqWK4jFZdhkVA.png)
...
![](http://chen_tiefeng.gitee.io/cloudimg/img/8qsP2MDIH3zJUQr.png)

提交线程

![](http://chen_tiefeng.gitee.io/cloudimg/img/GgheUwb3zR2vDWq.png)

##### 3.现在已经有点样子了，但是问题还很多，主要的一个问题：比如我建一个core=2,max=5,queue=5的线程池，假设往里面放了8个线程，会出现只运行了3个线程，跑完也就结束了，剩下的5个会在队列里面没处理，而且也不会保留2个核心线程

![](http://chen_tiefeng.gitee.io/cloudimg/img/1qIlu3MfazcRSYb.png)

 WheelThreadPool2的运行结果
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/s8qfZUwESzJmCYj.png)
 ...
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/TdhIqup7oNC1HBY.png)
 
 这样还有点问题，如果try里面出现异常，比如runnable.run异常或者r.run异常，这个线程就退出了，不能保持max个线程并行执行
 
 所以如果异常了需要重新创建一个线程继续跑循环，改造后
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/sXutaVeOb6jR7PS.png)
 ...
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/GkTIXzP4QjM75BY.png)
 
 这样改造后大概轮廓出来了，因为queue是阻塞队列，而且各个方法都加了线程锁，所以本身也是线程安全的，这部分代码貌似不需要加锁，跑个测试用例试下，貌似很合理
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/20191205154335.png)
 
 WheelThreadPoolTest3结果
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/QvD1yze4bmMZ2J6.png)
 ...
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191205_162746.png)
 
 再来测试下，存活时间设置为5秒，那样第二批只能提交5个线程，否则会导致线程池慢
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191205_163724.png)
 
 结果
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191205_164046.png)
 
 发生一个大问题，最后线程都没了，而且主线程也退出了
 
 原因：第一批的10个线程执行完后因为线程存活5秒，所以都保留了
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191205_165718.png)
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191205_165847.png)
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191205_170129.png)
 ...
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191205_170620.png)
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191205_170807.png)
 
 问题知道了，解决方法
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191205_181459.png)
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191205_181604.png)
 ...
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_092154.png)
 ...
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_094538.png)
...
> ```
 ...
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_100510.png)
 
 在新建worker的时候都加到workers里面去，这时候一想，activeCount和workers.size是不是重复了，顺带把activeCount删掉，用workers.size代替，线程执行完成workers.remove掉
 
 新增方法addWorker
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_101350.png)
 
 提交线程方法改造，删掉了activeCount，用workers.size代替
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_101451.png)
 
 worker的run方法改造，删掉了activeCount，用workers.size代替，activeCount-1用workers.remove(this)代替
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_101646.png)
  
 改造完了，查看一下，暴力关闭需要立即中断线程，抛弃队列，所以在while获取队列那里要增加判断
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_110800.png)
  
 提交线程方法增加状态判断
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_110914.png)
  
 改造完成，测试下暴力关闭
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_111151.png)
  
 结果，整个程序也退出了，线程池结束了，队列只运行了一个线程
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_111236.png)
...
#####  5.优雅关闭线程池
 ...
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_111747.png)
 
 提交线程方法增加状态，限制提交
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_151736.png)
...
> - 2.不存在线程还在执行（队列或者当前线程），调用workers所有线程的interrupt，防止存在线程在queue.take处阻塞
 ...
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_114516.png)
 
 
 每次执行完一个线程-1
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_115217.png)
  
 第一种情况，存在线程还在执行，在执行完成后判断remainingCount是否为0
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_115731.png)
 
 第二种情况，不存在线程还在执行，在stop的时候增加判断
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_115831.png)
 
 抽象封装下方法
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_120137.png)
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_120202.png)
 
 顺便把worker的run方法也优化下，一个屏幕都截不下了
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_140115.png)
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_140152.png)
 
 跑个第一种情况的测试用例
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_143611.png)
  
 结果出乎意料，居然没有结束所有线程
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_143703.png)
 
 加日志调试
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_143915.png)
 
 出现了更夸张的错误
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_144114.png)
 ...
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_150624.png)
 
 再次运行测试用例，结果符合预期了，这里的异常堆栈可以忽略
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_150955.png)
 
 再测试优雅关闭的第二种情况
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_151346.png)
 
 结果正常
 
 ![](http://chen_tiefeng.gitee.io/cloudimg/img/Clip_20191206_151509.png)
